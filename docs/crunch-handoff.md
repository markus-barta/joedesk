...
4. [#27](https://github.com/markus-barta/joedesk/pull/27) `feat/crunch-settings-ssot-map` → #33 (`37e54c7`, this note; sources panel already on #33)
5. [#26](https://github.com/markus-barta/joedesk/pull/26) `fix/joed17-resilience` → #27 (`eda78cb`, JOED-17 Gateway banner)
6. [#30](https://github.com/markus-barta/joedesk/pull/30) `feat/crunch-reporting-clarity` → #26 (`8e2df84`, decision-pulse smoke lock)
7. [#32](https://github.com/markus-barta/joedesk/pull/32) `docs/joed18-harness-health` → #30 (harness contract, then this verification note)
...
- Local proof on the #32 tip: `npm run check`, server contract (18), and `scripts/smoke-joe.mjs` for desktop, mobile, phone-order, and privacy. GitHub CI on the repaired heads is the remaining shared proof. #28, #31, and #33 were not rewritten.
