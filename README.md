...
**Version:** `26.09.12.20.36` (calendar `yy.mm.dd[.hh.mm]`; package and UI share `JoeVersion.APP_VERSION` in `public/joe/joe-version.js`).
...
```bash
docker build -t joedesk:26.09.12.20.36 .
```
